...
export default function HeroSection() {
  return (
    <section 
      ...
      className="mb-5"
    >
      <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8"> {/* Outer container for page alignment */}
        <div className="bg-primary rounded-[100px] py-16 px-4 sm:px-6 lg:px-8"> {/* Inner styled container with its own padding */}
