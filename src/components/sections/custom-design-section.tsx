    ...
    <section id="custom-design" className="py-16 md:py-24 bg-[#F1C644]">
      <div className="container mx-auto max-w-screen-md px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl sm:text-4xl font-bold text-[#3A3A3A] mb-6">
          Your Skincare Vision, Our Design Expertise
        </h2>
        <p className="text-lg text-[#3A3A3A] mb-10 max-w-xl mx-auto">
          Looking for a bespoke touch? Aura offers custom Canva template design services for skincare brands. We can create unique designs from scratch or customize our existing templates to perfectly capture your brand's aesthetic. Let's bring your specific vision to life.
        </p>
